...
$(function () {
    ...
    $('#chartContainer').highcharts({
            ...
            events: {
                load: function () {
                    ...
                    setInterval(function () {
                        if (enableChart) {
                            var x = (new Date()).getTime(), y = player.money;
        ...
        tooltip: {
            formatter: function () {
                return '<b>' + this.series.name + '</b><br/>' + Highcharts.dateFormat('%Y-%m-%d %H:%M:%S', this.x) + '<br/>' + displayNum(this.y, true);
            }
        },
        legend: {
            enabled: false
    ...
    var chart = $("#chartContainer").highcharts(), type = 1, types = ["logarithmic", "linear"];
